...
![Workflow result](https://github.com/GerardPaligot/my-soothe/workflows/Check/badge.svg)
...
Speed run is very challenging and happy to see that we can create screens with compose so quickly!
